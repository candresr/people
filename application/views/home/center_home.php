...
<body>
    ...
    <div id="howitworks">
        <div class="container-fluid">
            ...
            <div class="Qservicios row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6"> <img src="ico/como_4.png" class="img-responsive" alt="">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
                    ...
                    <p>Somos un Equipo de People Quicker´s, tendrás nuestro compromiso para asegurar la Idoneidad y Confiabilidad de tu Talento. <br><br><br>
                    Orgullosamente hacemos parte del Grupo Quick, Organización Empresarial de gran reconocimiento en Colombia que se proyecta como una de las Corporaciones de mayor impacto y crecimiento en Latinoamérica. <br><br></p>
                </div>
            </div>
    ...
    <div id="contactanos">
        ...
        <form action='<?php echo base_url('/index.php/web_home/emailContac');?>'  method="post" >
            ...
            <button type="button" class="btn btn-gray btn-center text-uppercase">Enviar</button>
            </form>
            <div id="tel">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="footerclass">
                        <h4>Links Rápidos</h4>
                        <ul>
                            <li><img src="ico/icoid.png" class="ico">Inicio</li>
                            <li><img src="ico/icoid.png" class="ico">Servicios</li>
                            <li><img src="ico/icoid.png" class="ico">Clientes</li>
                            <li><img src="ico/icoid.png" class="ico">Nosotros</li>
                            <li><img src="ico/icoid.png" class="ico">Trabaja con Nosotros</li>
                            <li><img src="ico/icoid.png" class="ico">Contactos</li>
                            <li><img src="ico/icoid.png" class="ico">Regitrate</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
                    <div class="footerclass">
                        <h4>Dirección Nacional</h4>
                         <ul>
                            <li> <img src="ico/icolocation.png" class="ico"> Bogotá</li>
                            <li><img src="ico/icotelephone.png" class="ico">(571) 7470547</li>
                            <li><img src="ico/icohome.png" class="ico"> Cra 92 Nº- 64C - 12 Cedi Quick</li>
                            <li><img src="ico/icomail.png"  class="ico"> sac@peoplequick.co</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="footerclass">
                        <h4>Nuestro Grupo</h4>
                        <img src="ico/GrupoQuickVEC.png" width="250" alt="Grupo_quick_logo" id="GrupoQuickLogo"> </div>
                </div>
            </div>
        </div>
    </div>
    <div class="footerline">
       <a>2015 PeopleQuick - Talento Comfortable</a>
    ...
    <script src="./js/funcionaux.js"></script>
    <!-- Just to make our placeholder images work. Don't actually copy the next line!
    <script src="./Carousel Template for Bootstrap_files/holder.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug
    <script src="./Carousel%20Template%20for%20Bootstrap_files/"></script> -->
</body>
